"""
Not intended for execution, but rather for importation of variables 
via __init__.py file. 

Here, the equations of motion for the double-pendulum in a cart are
automatically derived. The results are stored and later imported into
custom environments.
...
# Lagrange Equations (notice the coefficients 'a' thru 'l'):
